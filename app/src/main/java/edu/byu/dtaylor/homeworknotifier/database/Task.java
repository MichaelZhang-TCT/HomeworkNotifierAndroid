...
public class Task {
    ...
    public Task(String assignmentId, String courseId, String name, String description, String category, String categoryId, String dueDate, String graded, String points, String weight, String type, String refUrl) {
